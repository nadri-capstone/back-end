    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.d("HWA", "btnSave appendList: " + appendList);
                Log.d("HWA", "btnSave uriList: " + uriList);
                ReqServer.reqPostPages(AlbumLayout.this, uriList, appendList);
            }
        });
        ...
        //서버테스트
        Log.d("HWA", "reqGetPages uriList: " + uriList);
        try {
            ReqServer.sDate = CalendarUtil.selectedDate.get(Calendar.YEAR) + "-" + (CalendarUtil.selectedDate.get(Calendar.MONTH)+1) + "-" + iDay;
            String sDate = CalendarUtil.selectedDate.get(Calendar.YEAR) + "-" + (CalendarUtil.selectedDate.get(Calendar.MONTH)+1) + "-" + iDay;
            ReqServer.reqGetPages(AlbumLayout.this, uriList);
        } catch (Exception e) {
            e.printStackTrace();
            Log.d("HWA", e + "");
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(data == null){
            ...
            if(data.getClipData() == null){
                ...
                appendList.add(uriList.size() - 1);
                Log.d("HWA", "uriList size: " + uriList.size() + " appendList size: " + appendList.size());
                ...
                for(int i=0; i< clipData.getItemCount(); i++){
                    ...
                    try {
                        ...
                        appendList.add(uriList.size() - 1);
                        Log.d("HWA", "uriList size: " + uriList.size() + " " + uriList);
                                Log.d("HWA", "appendList size: " + appendList.size() + " " + appendList);
                    }catch (Exception e){
